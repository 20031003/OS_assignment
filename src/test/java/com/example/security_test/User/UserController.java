package com.example.security_test.User;
...
public class UserController {
    ...
    void checkEmailToken_with_wrong_input() throws Exception {
        mockMvc.perform(get("/check-email-token")
                ...
                .andExpect(view().name("email/checkedEmail"));
//                .andExpect(unauthenticated());
    ...
    void checkEmailToken() throws Exception {
        UserEntity account = UserEntity.builder()
                ...
                .username("prs123")
                .build();
        UserEntity newAccount = userRepository.save(account);
        ...
        mockMvc.perform(get("/check-email-token")
                ...
                .andExpect(view().name("email/checkedEmail"));
//                .andExpect(authenticated().withUsername("prs123"));
